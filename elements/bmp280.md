...
The BMP280 from bosch combines a temperature and an absolute barometric air pressure sensor into one chip.

The physical communication is done via the I2C bus to read raw data values 
as well as some correction factors to calculate the temperature in celcius and pressure in ???.
