...
The INA226 is a current and voltage sensor that uses the I2C bus for communication and can easily be adapted to any Arduino microcontroller including ESP6266 and EPS32.
It can be powered by 3.3V to 5V but can measure voltages up to 26V.
```

This module has 4 connectors and breaks out the 4 signal sensing pins from the chip:
VBUS, VIN+, VIN- and GND.
This allows to use the module for current measurement using the built-in shunt in the High-Side or Low-Side.
